        ...
        switch (view.getId()) {
            ...
            case R.id.btn_sendcode:
                ...
                if (TextUtils.isEmpty(phone)) {
                    ...
                    OkHttpUtils.post().url(NetConfig.FORGETPWD_SENDCODE_URL)
                            ...
                            .execute(new StringCallback() {
                                ...
                                public void onResponse(String response, int id) {
                                    Log.e("aaa","--忘记密码发送验证码返回---->"+response);
                                    try {
            ...
            case R.id.btn_config:
                ...
                if(TextUtils.isEmpty(phone1)){
                    ...
                    startActivity(new Intent(this, ForgetPwdNextActivity.class).putExtra("phone",phone1).putExtra("code",code));
                }
                break;
        }
    }
